(function(angular, $) {
    ...
    angular.module('FileManagerApp').service('apiHandler', ['$http', '$q', '$window', '$translate', 'Upload',
        ...
        ApiHandler.prototype.coclustSpecMod = function(apiUrl, item, folderName, path) {
            var self = this;
            var deferred = $q.defer();
            var data = {
                action: 'coclustSpecMod',
                item: item,
                destination: path,
                folderName: folderName
            };
        ...
        ApiHandler.prototype.coclustInfo = function(apiUrl, item, folderName, path) {
            var self = this;
            var deferred = $q.defer();
            var data = {
                action: 'coclustInfo',
